...
<template>
    <v-app>
                ...
                <v-menu>
                    <template v-slot:activator="{ props }">
                        ...
                        >
                            ...
                            <template #append>
                                <v-icon size="20" icon="mdi-unfold-more-horizontal" />
                            </template>
                        </v-list-item>
                    </template>
                    <v-list density="compact" nav>
                        <v-list-item title="Profile" prepend-icon="mdi-account" :to="route('profile.edit')" />
                        <v-list-item title="Settings" prepend-icon="mdi-cog" :to="route('profile.edit')" />
                        <v-list-item title="Notifications" prepend-icon="mdi-bell" :to="route('profile.edit')" />
                        <v-divider class="mb-1" />
                        <v-list-item title="Get desktop app" prepend-icon="mdi-monitor" :to="route('profile.edit')" />
                        <v-list-item title="Support" prepend-icon="mdi-face-agent" :to="route('profile.edit')" />
                        <v-divider class="mb-1" />
                        <v-list-item title="Logout" prepend-icon="mdi-logout" @click="logoutForm.post(route('logout'))" />
                    </v-list>
                </v-menu>
            </div>
        ...
        <v-app-bar flat border style="border-left: 0; border-right: 0;">
            <template #title>
                {{ title }}
            </template>
            <v-spacer />
